...
def get_encoder(hidden_size,vocab_size,dropout=0.2,num_layers=2,
    ...
    cells=[layers.GRUCell(hidden_size,dropout=dropout) for _ in range(num_layers-1)]
    cells.append(layers.GRUCell(hidden_size))
    gru=layers.RNN(cells,return_sequences=False,return_state=True,name='multi-gru')
