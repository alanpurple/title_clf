...
spm.SentencePieceTrainer_Train('--input=titles.txt --model_type=bpe --model_prefix=./vocab/spm vocab_size=24000')
...
with tf.io.TFRecordWriter('sp_category_dev.tfrecord') as writer:
